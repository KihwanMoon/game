...
def build_bag_item(item_id, slot, can_equip=True, is_broken=False):
    ...
    Returns:
        물건.
    """
    from game.app.bots.chores import BagItem
...
def test_an_empty_slot_gets_filled():
    ...
    """
    from game.app.bots.chores import list_equippable
...
def test_unspent_points_get_spent():
    ...
    """
    from game.app.bots.chores import build_allocation
...
def build_slot(use_tag, slot_index, catalog_id=""):
    ...
    Returns:
        칸.
    """
    from game.app.bots.chores import ConsumableSlot
...
def build_option(catalog_id, use_tag, count=1):
    ...
    Returns:
        후보.
    """
    from game.app.bots.chores import ConsumableOption
...
def test_an_empty_slot_gets_loaded():
    ...
    """
    from game.app.bots.chores import list_loadable
...
def test_the_payload_field_names_match_the_server():
    ...
    """
    from game.app.bots.chores import parse_consumables
...
def test_the_real_payload_actually_loads():
    ...
    from game.app.bots.chores import list_loadable, parse_consumables
